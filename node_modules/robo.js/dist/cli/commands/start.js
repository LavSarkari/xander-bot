...
const command = new Command("start").description("Starts your bot in production mode.").option("-id", "--instance-id", "specify the instance ID to use").option("-l", "--log-level", "specify the log level to use (debug, info, warn, error)").option("-m", "--mode", "specify the mode(s) to run in (dev, beta, prod, etc...)").option("-h", "--help", "Shows the available command options").option("-s", "--silent", "do not print anything").option("-v", "--verbose", "print more information for debugging").handler(startAction);
