 ...
 */
declare function consoleDrain(_logger: Logger, level: string, ...data: unknown[]): Promise<void>;
...
export { ANSI_REGEX, DEBUG_MODE, LogDrain, LogLevel, Logger, LoggerOptions, consoleDrain, logger };
